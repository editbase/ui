---
title: 'Banner'
description: 'Call to action banner that stick to the top or bottom of the page.'
---
...
<ui-component-preview data-tab="preview">
  ...
  <div data-content>
    <ui-banner class="w-full">
      <div class="flex items-center justify-between h-full px-4 mx-auto max-w-7xl w-full min-h-[40px] border-b border-muted-foreground/15">
        <a href="#" class="flex flex-col w-full h-full text-xs leading-6 duration-150 ease-out sm:flex-row sm:items-center opacity-80 hover:opacity-100">
            <span class="flex items-center">
                ...
                <strong class="font-semibold">New Feature</strong><span class="hidden w-px h-4 mx-3 rounded-full sm:block bg-muted-foreground"></span>
            </span>
            <span class="block pt-1 pb-2 leading-none sm:inline sm:pt-0 sm:pb-0">Click here to learn about our latest feature</span>
        </a>
        <button class="flex items-center flex-shrink-0 translate-x-1 ease-out duration-150 justify-center w-6 h-6 p-1.5 rounded-full hover:bg-muted-foreground/20">
    ...
    <div class="flex flex-1 bg-muted-foreground/5">  
    </div>
  </div>
